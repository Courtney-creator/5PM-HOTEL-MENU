...
function WhatsAppButton() {
  return (
    <a
      ...
      className="fixed bottom-6 right-6 z-50 flex items-center justify-center rounded-full shadow-lg transition-all hover:scale-110"
      style={{ background: '#25D366', width: '56px', height: '56px' }}
    >
      <svg viewBox="0 0 24 24" fill="white" width="28" height="28">
        ...
        <path d="M12 0C5.373 0 0 5.373 0 12c0 2.123.554 4.135 1.532 5.88L.057 23.428a.5.5 0 00.609.61l5.652-1.464A11.945 11.945 0 0012 24c6.627 0 12-5.373 12-12S18.627 0 12 0zm0 21.818a9.818 9.818 0 01-5.006-1.371l-.36-.214-3.722.964.991-3.624-.235-.374A9.818 9.818 0 1112 21.818z"/>
      </svg>
    </a>
  );
}
